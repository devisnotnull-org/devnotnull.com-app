...
export const getBlogContent = createSelector(
  getBlogItem,
  (state) => state.fields.blogContent,
);

export const getBlogSlug = createSelector(
  getBlogItem,
  (state) => state?.fields.slug,
);

export const getBlogTitle = createSelector(
  getBlogItem,
  (state) => state?.fields.title,
);

export const getBlogAssets = createSelector(
  getBlogItem,
