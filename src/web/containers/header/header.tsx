        ...
        >
          <li className={classnames(styles['Link'], styles['Link--left'])}>
            <Link to={'/'} onClick={() => this.toggleMenu(false)}>
              <Favicon name={'folio'} className={styles['LinkIcon']} />
              Profile
            </Link>
          </li>
          <li className={classnames(styles['Link'], styles['Link--left'])}>
            <Link to={'/blog'} onClick={() => this.toggleMenu(false)}>
              <Favicon name={'blog'} className={styles['LinkIcon']} />
              Blog
            </Link>
          </li>
          <li className={classnames(styles['Link'], styles['Link--left'])}>
            ...
            >
              <Favicon name={'github'} className={styles['LinkIcon']} />
              Github
            </Link>
          </li>
          <li className={classnames(styles['Link'], styles['Link--left'])}>
            <Link
              ...
              onClick={() => this.toggleMenu(false)}
            >
              <Favicon name={'linked'} className={styles['LinkIcon']} />
              Linkedin
            </Link>
          </li>
        </ul>
