...
export const HomeView: FC = () => {
  ...
  return (
    <div className='mt-5 p-5 md:p-10 bg-white rounded-lg shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur text-base'>
      <h1 className='text-2xl pb-3.5 mb-2 md:7 text-left font-bold text-gray-600 font-harman'>About me</h1>
      ...
      <h1 className='text-2xl py-3.5 my-2 md:7 text-left font-bold text-gray-600 font-harman'>Newest blog posts</h1>
      ...
      <h1 className='text-2xl py-3.5 my-2 md:7 text-left font-bold text-gray-600 font-harman'>Experience</h1>
